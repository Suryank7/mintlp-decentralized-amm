    ...
    <div className="container mx-auto py-8 px-4">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold gradient-text mb-2">My Positions</h1>
            <p className="text-muted-foreground">
              Manage your NFT-based liquidity provider positions
            </p>
          </div>
          <Button onClick={() => navigate('/liquidity')} size="lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="card-gradient rounded-lg border p-6">
            ...
            <div className="text-3xl font-bold">{formatUSD(portfolio.totalValueUSD)}</div>
          </div>
          <div className="card-gradient rounded-lg border p-6">
        ...
        {positions.length > 0 ? (
          ...
          <Card className="shadow-card">
            <CardContent className="flex flex-col items-center justify-center py-12 space-y-4">
              <div className="text-center space-y-2">
                <h2 className="text-2xl font-bold">No Positions Yet</h2>
                <p className="text-muted-foreground">
